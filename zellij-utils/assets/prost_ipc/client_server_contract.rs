...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ActionType {
        ...
        GoToSwapLayout(super::GoToSwapLayoutAction),
        ...
        GoToSwapLayoutByTabId(super::GoToSwapLayoutByTabIdAction),
    }
}
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GoToSwapLayoutAction {
    #[prost(string, tag="1")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GoToSwapLayoutByTabIdAction {
    #[prost(uint64, tag="1")]
    pub id: u64,
    #[prost(string, tag="2")]
    pub name: ::prost::alloc::string::String,
